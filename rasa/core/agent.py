...
class Agent:
    ...
    async def parse_message_using_nlu_interpreter(
        self, message_data: Text, tracker: DialogueStateTracker = None, lang: Optional[Text] = None, # clai
    ) -> Dict[Text, Any]:
        ...
        message = UserMessage(message_data, metadata={"language": lang}) # claichanges
